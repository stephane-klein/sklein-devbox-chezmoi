...
Skill for creating Node.js + PostgreSQL projects based on Stéphane Klein's preferences.
...
- **Preserves script groupings**: sort-package-json forces alphabetical sorting of scripts, erasing intentional developer groupings (dev tools, db, cli, lifecycle). npm-package-json-lint only validates property order — scripts stay human-organized.
